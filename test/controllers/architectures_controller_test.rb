...
class ArchitecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create architecture" do
    assert_difference('Architecture.count') do
      post architectures_url, params: { architecture: { auteur: @architecture.auteur, date: @architecture.date, nom: @architecture.nom, photo: @architecture.photo } }
    end
  ...
  test "should update architecture" do
    patch architecture_url(@architecture), params: { architecture: { auteur: @architecture.auteur, date: @architecture.date, nom: @architecture.nom, photo: @architecture.photo } }
