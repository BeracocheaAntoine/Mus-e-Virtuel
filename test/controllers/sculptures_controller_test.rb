...
class SculpturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sculpture" do
    assert_difference('Sculpture.count') do
      post sculptures_url, params: { sculpture: { auteur: @sculpture.auteur, date: @sculpture.date, nom: @sculpture.nom, photo: @sculpture.photo } }
    end
  ...
  test "should update sculpture" do
    patch sculpture_url(@sculpture), params: { sculpture: { auteur: @sculpture.auteur, date: @sculpture.date, nom: @sculpture.nom, photo: @sculpture.photo } }
