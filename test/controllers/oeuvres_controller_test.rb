...
class OeuvresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oeuvre" do
    assert_difference('Oeuvre.count') do
      post oeuvres_url, params: { oeuvre: { auteur: @oeuvre.auteur, date: @oeuvre.date, nom: @oeuvre.nom, photo: @oeuvre.photo } }
    end
  ...
  test "should update oeuvre" do
    patch oeuvre_url(@oeuvre), params: { oeuvre: { auteur: @oeuvre.auteur, date: @oeuvre.date, nom: @oeuvre.nom, photo: @oeuvre.photo } }
